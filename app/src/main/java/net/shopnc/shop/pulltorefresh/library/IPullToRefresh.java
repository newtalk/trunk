...
import net.shopnc.shop.pulltorefresh.library.PullToRefreshBase.Mode;
import net.shopnc.shop.pulltorefresh.library.PullToRefreshBase.OnPullEventListener;
import net.shopnc.shop.pulltorefresh.library.PullToRefreshBase.OnRefreshListener;
import net.shopnc.shop.pulltorefresh.library.PullToRefreshBase.OnRefreshListener2;
import net.shopnc.shop.pulltorefresh.library.PullToRefreshBase.State;
